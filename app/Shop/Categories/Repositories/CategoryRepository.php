...
class CategoryRepository extends BaseRepository implements CategoryRepositoryInterface
{
    ...
    {       
        try {
            ...
            $slug = (isset($params['descricao'])) ? str_slug($params['descricao']) : '';

            $cover = (isset($params['banner']) && ($params['banner'] instanceof UploadedFile)) ?
                $this->uploadOne($params['banner'], 'categories') : '';
