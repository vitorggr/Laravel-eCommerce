            ...
            <div class="col-12">
                ...
                <div id="page-wrap">
                    <div id="sidebar_left" class="sidebar_left clearfix">
                        ...
                        <div class="clear_price_btn"><a class="clear_filter" href="busca?produto={{$q}}">Limpar Filtro</div>
                        <!-- Price -->
                        ...
                        <div class="sidebar_section">
                            ...
                            <div class="sidebar_section_content sidebar_color_content mCustomScrollbar" data-mcs-theme="minimal-dark">
                                ...
                                <li><a href="#"><span style="background:#f52832"></span>Vermelho</a></li> -->
                                    ...
                                    @if(isset($q) && request()->input('tamanho')==null)
                                    <li><a href="busca?produto={{$q}}&cor={{str_slug($color->descricao,'-')}}">
                                            <span style="background:{{$color->hexadecimal}}"></span>{{str_slug($color->descricao,'-')}}</a></li>
                                    @else
                                    <li><a href="busca?produto={{$q}}&cor={{str_slug($color->descricao,'-')}}&tamanho={{request()->input('tamanho')}}">
                                            <span style="background:{{$color->hexadecimal}}"></span>{{str_slug($color->descricao,'-')}}</a></li>
                                    @endif
                                    @endforeach
                        ...
                        <div class="sidebar_section">
                            ...
                            <div class="sidebar_section_content">
                                <ul>
                                    ...
                                    <li><a href="busca?produto={{$q}}&cor={{request()->input('cor')}}&tamanho=PP">PP</a></li>
                                    <li><a href="busca?produto={{$q}}&cor={{request()->input('cor')}}&tamanho=P">P</a></li>
                                    <li><a href="busca?produto={{$q}}&cor={{request()->input('cor')}}&tamanho=M">M</a></li>
                                    <li><a href="busca?produto={{$q}}&cor={{request()->input('cor')}}&tamanho=G">G</a></li>
                                    <li><a href="busca?produto={{$q}}&cor={{request()->input('cor')}}&tamanho=GG">GG</a></li>
                                    @else
                                    <li><a href="busca?produto={{$q}}&tamanho=PP">PP</a></li>
                                    <li><a href="busca?produto={{$q}}&tamanho=P">P</a></li>
                                    <li><a href="busca?produto={{$q}}&tamanho=M">M</a></li>
                                    <li><a href="busca?produto={{$q}}&tamanho=G">G</a></li>
                                    <li><a href="busca?produto={{$q}}&tamanho=GG">GG</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
    ...
    <div class="sidebar_right clearfix">
        ...
        <div class="sidebar_promo_1 sidebar_promo d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="sidebar_promo_content text-center">
                ...
                <div class="sidebar_promo_button"><a href="../promoção/{{$cards[0]->descricao}}">Comprar</a></div>
            </div>
        </div>
        ...
        <div class="sidebar_promo_2 sidebar_promo">
            ...
            <div class="sidebar_promo_content text-center">
                ...
                <div class="sidebar_promo_button"><a href="../promoção/{{$cards[1]->descricao}}">Comprar</a></div>
            </div>
        </div>
        @endif
        @endif
