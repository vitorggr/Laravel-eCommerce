...
<meta property="og:title" content="coleção" />
<meta property="og:description" content="Coleção" />
<link rel="canonical" href="http://www.easyshop.com.br/colecao" />
            ...
            <div class="col">
                <div class="home_container">
                    <div class="home_content">
                        <div class="home_title">{{$collection->descricao}}</div>
                        <div class="breadcrumbs">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li>Coleção</li>
                                <li>{{$collection->descricao}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div id="sidebar_left" class="sidebar_left clearfix">
            <div class="container-sidebar">
                <div class="clear_price_btn"><a class="clear_filter" href="../colecao/{{str_slug($slug,'-')}}">Limpar Filtro</a></div>
                ...
                <div class="sidebar_section">
                    ...
                    <div class="sidebar_section_content sidebar_color_content mCustomScrollbar" data-mcs-theme="minimal-dark">
                        ...
                        <li><a href="#"><span style="background:#f52832"></span>Vermelho</a></li> -->
                            ...
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug($color->descricao,'-')}}">
                                    <span style="background:{{$color->hexadecimal}}"></span>{{$color->descricao}}</a></li>
                            @else
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug($color->descricao,'-')}}&tamanho={{request()->input('tamanho')}}">
                                    <span style="background:{{$color->hexadecimal}}"></span>{{$color->descricao}}</a></li>
                            @endif
                            @endforeach
                ...
                <div class="sidebar_section">
                    ...
                    <div class="sidebar_section_content">
                        <ul>
                            ...
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug(request()->input('cor'))}}&tamanho=PP">PP</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug(request()->input('cor'))}}&tamanho=P">P</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug(request()->input('cor'))}}&tamanho=M">M</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug(request()->input('cor'))}}&tamanho=G">G</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&cor={{str_slug(request()->input('cor'))}}&tamanho=GG">GG</a></li>
                            @else
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&tamanho=PP">PP</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&tamanho=P">P</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&tamanho=M">M</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&tamanho=G">G</a></li>
                            <li><a href="../colecao?colecao={{str_slug($slug,'-')}}&tamanho=GG">GG</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
