                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="description" id="description" rows="5" placeholder="Descrição">{!! $product->description  !!}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <div class="row">
                                                ...
                                                @foreach($images as $image)
                                                    <div class="col-md-3">
                                                        <div class="row">
                                                            ...
                                                            <a onclick="return confirm('Continuar ?')" href="{{ route('admin.product.remove.thumb', ['src' => $image->src]) }}" class="btn btn-danger btn-sm btn-block">Remover?</a><br />
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="text-warning">Você pode utilizar o "ctrl" e adicionar várias imagens</span>
                                            </div>
                                            <div class="form-group">
