            ...
            <form action="{{ route('admin.couriers.update', $courier->id) }}" method="post" class="form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" placeholder="" class="form-control" value="{{ $courier->name ?: old('name') }}">
                    </div>
                    <div class="form-group">
                        <label for="description">Descrição </label>
                        <textarea name="description" id="description" rows="5" class="form-control" placeholder="">{{ $courier->description ?: old('description') }}</textarea>
                    </div>
                    <div class="form-group">
