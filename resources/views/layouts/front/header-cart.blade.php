...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    ...
    <ul class="nav navbar-nav navbar-right">
        @if(\Auth::check())
            <li class="visible-xs"><a href="{{ route('conta', ['tab' => 'profile']) }}"><i class="fa fa-home"></i> Minha Conta</a></li>
        ...
        <li id="cart" class="menubar-cart visible-xs">
            <a href="{{ route('carrinho.index') }}" title="Ver Carrinho" class="awemenu-icon menu-shopping-cart">
        ...
        <li>
            ...
            <form action="{{route('search.product')}}" method="GET" class="form-inline" style="margin: 15px 0 0;">
                <div class="input-group">
                    <input type="text" name="q" class="form-control" placeholder="Digite sua pesquisa..." value="{!! request()->input('q') !!}">
                    <span class="input-group-btn">
                        <button type="submit" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i> Pesquisar</button>
                    </span>
                </div>
            </form>
            <!-- /.search form -->
